...
// var result = '20' === 20 // false // 더 엄격하다 

// != value (값)이 다르다
// var result = '20' != 20 // false

// !== value(값) 또는 type(타입)이 다르다
// var result = '20' !== 20 // true // 더 엄격하다

// var result = 20 > 22 // false
// console.log(result)
...
// && and (그리고) 둘다 일치를 해야 true가 나온다
// var result = 22 > 0 && 22 > 20

// || or (또는) 둘중 하나만 맞으면 true가 나온다
// var result = 22 > 0 || 22 < 20

// ! not (부정)

// var result = 22 > 20 // true
// var result = !(22 > 20) // false
// console.log(result)
...
// console.log(cars[0]) // index 0 에 접근 순서는 1이 아닌 0부터 시작한다
...
//     { name: '캐서퍼', design:8 , color: ["그린", "베이지"]},
// ]
...
// // inclubes(value) vale를 포함했는지 여부
// var bool = cars.includes("캐스퍼"); //false
...
//     console.log(data)
// }
// // 콜백함수에는 인자가 있을 때는 익명함수가 필요하다

// myFunction(myCallback(2)) //error

// myFunction(function () { //ok
//     myCallback(2)
// })
...
var cars = [
    ...
    { name: '벤츠', onSale: false },
    { name: '아우디', onSale: true },
    { name: '페라리', onSale: true },
    { name: 'BMW', onSale: true },
]
